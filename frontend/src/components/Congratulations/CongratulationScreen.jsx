...
const CongratulationsScreen = () => {
	...
	const nextGameRoute = `/game/${difficultyKey}`;
	...
	useEffect(() => {
		const handleStorageChange = () => {
			const newVolume = parseInt(localStorage.getItem("bgVolume"), 10) || 50;
	...
	return (
		<PixelBox>
			...
			<ButtonContainer>
				<PixelButton onClick={handlePlayAgain}>Play Again?</PixelButton>
				<PixelButton onClick={handleExit}>Exit</PixelButton>
			</ButtonContainer>
		</PixelBox>
	);
};
